...
import Animated, { Easing, FadeIn, FadeInUp, FadeOut, useAnimatedReaction, useSharedValue } from "react-native-reanimated";
...
function Item({ image, index }: { image: any, index: number }) {
    return (
        <View
            style={{
                width: _itemWidth,
...
export default function AppleInvite() {
    ...
    return (
        <View style={{ flex: 1, justifyContent: "center", alignItems: 'center', backgroundColor:"#000" }}>
            ...
            >
                <Animated.View 
                    entering={FadeInUp.delay(500).duration(1000).easing(Easing.elastic(0.5)).withInitialValues({
